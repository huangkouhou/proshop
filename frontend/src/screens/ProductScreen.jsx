...
//从 Redux 全局状态中，获取当前登录用户的信息，并把它解构出来使用。state.auth 是 authSlice中定义的登录相关状态（如 userInfo、token、isLoading 等）
...
//as="select"这是 React-Bootstrap 的一种写法，用来告诉 <Form.Control> 组件：👉 “我要把它渲染成一个 <select> 下拉框。”
